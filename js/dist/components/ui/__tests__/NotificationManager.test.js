...
describe('NotificationManager', () => {
    ...
    describe('constructor', () => {
        it('should create notification container', () => {
            ...
            expect(newContainer === null || newContainer === void 0 ? void 0 : newContainer.className).toBe('notification-container');
            expect(newContainer === null || newContainer === void 0 ? void 0 : newContainer.style.position).toBe('fixed');
        });
        ...
        it('should apply custom default options', () => {
            ...
            expect(customContainer === null || customContainer === void 0 ? void 0 : customContainer.style.bottom).toBe('0px');
            expect(customContainer === null || customContainer === void 0 ? void 0 : customContainer.style.right).toBe('0px');
        });
    });
    describe('show', () => {
        beforeEach(() => {
        ...
        it('should create and display notification', () => {
            ...
            expect(notification === null || notification === void 0 ? void 0 : notification.textContent).toContain('Test message');
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('notification-info')).toBe(true);
        });
        ...
        it('should show persistent notification', () => {
            ...
            const notification = document.getElementById(id);
            expect(notification).toBeTruthy();
            expect(notification === null || notification === void 0 ? void 0 : notification.querySelector('.notification-close')).toBeTruthy();
        });
        it('should handle click event', () => {
            const onClick = jest.fn();
            const id = notificationManager.show('Clickable', 'info', { onClick });
            const notification = document.getElementById(id);
            notification === null || notification === void 0 ? void 0 : notification.click();
        ...
        it('should close persistent notification on close button click', () => {
            ...
            const notification = document.getElementById(id);
            const closeBtn = notification === null || notification === void 0 ? void 0 : notification.querySelector('.notification-close');
        ...
        it('should apply custom className', () => {
            ...
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('custom-notification')).toBe(true);
        });
    });
    describe('notification types', () => {
        it('should show success notification', () => {
            ...
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('notification-success')).toBe(true);
            expect(notification === null || notification === void 0 ? void 0 : notification.style.backgroundColor).toBe('rgb(76, 175, 80)');
        });
        it('should show error notification', () => {
            const id = notificationManager.error('Error!');
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('notification-error')).toBe(true);
            expect(notification === null || notification === void 0 ? void 0 : notification.style.backgroundColor).toBe('rgb(244, 67, 54)');
        });
        it('should show warning notification', () => {
            const id = notificationManager.warning('Warning!');
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('notification-warning')).toBe(true);
            expect(notification === null || notification === void 0 ? void 0 : notification.style.backgroundColor).toBe('rgb(255, 152, 0)');
        });
        it('should show info notification', () => {
            const id = notificationManager.info('Info!');
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('notification-info')).toBe(true);
            expect(notification === null || notification === void 0 ? void 0 : notification.style.backgroundColor).toBe('rgb(33, 150, 243)');
        });
    });
    describe('hide', () => {
        beforeEach(() => {
        ...
        it('should hide specific notification', () => {
            ...
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.style.opacity).toBe('0');
            jest.advanceTimersByTime(300);
            expect(document.getElementById(id)).toBeFalsy();
        });
    ...
    describe('position options', () => {
        ...
        positions.forEach(({ position, expectedStyles }) => {
            it(`should position container at ${position}`, () => {
                new NotificationManager({ position: position });
                const container = document.getElementById('notification-container');
                Object.entries(expectedStyles).forEach(([prop, value]) => {
                    expect(container === null || container === void 0 ? void 0 : container.style[prop]).toBe(value);
                });
            });
        });
    });
    describe('animation', () => {
        ...
        it('should animate notification on show', () => {
            ...
            const notification = document.getElementById(id);
            expect(notification === null || notification === void 0 ? void 0 : notification.style.opacity).toBe('0');
            expect(notification === null || notification === void 0 ? void 0 : notification.style.transform).toBe('translateY(-20px)');
            // After requestAnimationFrame
            jest.runAllTimers();
            expect(notification === null || notification === void 0 ? void 0 : notification.classList.contains('notification-show')).toBe(true);
        });
    });
});
