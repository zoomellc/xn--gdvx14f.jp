...
describe('StorageManager', () => {
    ...
    describe('constructor', () => {
        it('should use default prefix when not provided', () => {
            ...
            expect(localStorage.setItem).toHaveBeenCalledWith(expect.stringContaining('keigo_key'), expect.any(String));
        });
        it('should use custom prefix when provided', () => {
            storage.set('key', 'value');
            expect(localStorage.setItem).toHaveBeenCalledWith(expect.stringContaining('test_key'), expect.any(String));
        });
    });
    describe('set', () => {
        it('should store value with timestamp', () => {
            ...
            expect(localStorage.setItem).toHaveBeenCalledWith('test_key', expect.stringContaining('"value":"value"'));
            expect(localStorage.setItem).toHaveBeenCalledWith('test_key', expect.stringContaining('"timestamp":'));
        });
        it('should store value with TTL', () => {
            const ttl = 5000;
            storage.set('key', 'value', ttl);
            expect(localStorage.setItem).toHaveBeenCalledWith('test_key', expect.stringContaining('"expires":'));
        });
