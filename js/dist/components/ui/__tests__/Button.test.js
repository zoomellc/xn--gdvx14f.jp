...
describe('Button', () => {
    ...
    describe('onClick handler', () => {
        it('should call onClick when clicked', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should handle async onClick', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should not call onClick when loading', () => __awaiter(void 0, void 0, void 0, function* () {
            const onClick = jest.fn();
            const button = new Button({
                text: 'Loading',
                loading: true,
    ...
    describe('tooltip', () => {
        ...
        it('should show tooltip on hover', () => {
            ...
            expect(tooltip === null || tooltip === void 0 ? void 0 : tooltip.textContent).toBe('This is a tooltip');
        });
